...
class Tiqr_Service
{
    ...
    public function generateAuthQR($sessionKey)
    {
        ...
        return "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=".$challengeUrl;
    }
    ...
    { 
        ...
        return "https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl=".$enrollmentString;
    }
