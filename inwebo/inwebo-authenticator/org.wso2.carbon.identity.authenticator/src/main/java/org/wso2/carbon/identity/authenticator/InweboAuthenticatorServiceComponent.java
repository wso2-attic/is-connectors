...
public class InweboAuthenticatorServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        InweboAuthenticator duoAuth = new InweboAuthenticator();
    ...
    protected void setRealmService(RealmService realmService) {
        ...
        InweboAuthenticatorServiceComponent.realmService = realmService;
    }

    protected void unsetRealmService(RealmService realmService) {
        log.debug("UnSetting the Realm Service");
        InweboAuthenticatorServiceComponent.realmService = null;
    }
